...
class AskViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBAction func submitButtonAction(sender: AnyObject) {
        ...
        dispatch_async(dispatch_get_main_queue()) { () -> Void in
            ...
            dispatch_async(dispatch_get_main_queue()) { () -> Void in
                ...
                if (self.filled["Q"] == 1 || self.question != "") && (self.filled["O1"] == 1 || self.option1 != "") && (self.filled["O2"] == 1 || self.option2 != "") {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        var frame = self.askTable.frame
        frame.size.height = self.askTable.contentSize.height;
        self.askTable.frame = frame;
        }
        */
    ...
    func tableView(askTable: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case 0://QUESTION
            ...
            // Fill question text
            if cell.questionTextField.text != "" {
...
//                if cell.option1TextField.text != "" && cell.option2TextField.text != "" && self.filled["O1"]! == 0 && self.filled["O2"]! == 0  {
//                    
//                    filled["O1"] = 1
//                    option1 = cell.option1TextField.text
//                    option2 = cell.option2TextField.text
